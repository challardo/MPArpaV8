...
public class FavoritesOperations {
    ...
    private static final String[] allColumns = {
            ...
            FavoritesDBHandler.COLUMN_ABLUM,
            FavoritesDBHandler.COLUMN_DURATION,
    ...
    public void addSongFav(SongsList songsList) {
        ...
        values.put(FavoritesDBHandler.COLUMN_ID, songsList.getId());
        ...
        values.put(FavoritesDBHandler.COLUMN_ABLUM, songsList.getAlbum());
        values.put(FavoritesDBHandler.COLUMN_DURATION, songsList.getDuration());
    ...
    public ArrayList<SongsList> getAllFavorites() {
        ...
        if (cursor.getCount() > 0) {
            while (cursor.moveToNext()) {
                SongsList songsList = new SongsList(cursor.getString(cursor.getColumnIndex(FavoritesDBHandler.COLUMN_ID))
                        ...
                        ,cursor.getString(cursor.getColumnIndex(FavoritesDBHandler.COLUMN_ABLUM))
                        , cursor.getString(cursor.getColumnIndex(FavoritesDBHandler.COLUMN_DURATION)));
